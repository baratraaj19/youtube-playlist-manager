  ...
  return (
    <div className="w-80 border-l border-[#2E2E3A] bg-[#1C1C24] flex flex-col">
      <div className="p-4 border-b border-[#2E2E3A]">
        <h2 className="text-lg font-semibold mb-4 text-white">Thumbnail Title</h2>
        <Input
          type="text"
          placeholder="Get Sporty in Style"
          className="mb-4 bg-[#13131A] border-[#2E2E3A] text-white"
        />
        <Label className="text-sm font-medium mb-2 text-white">Video status</Label>
        <RadioGroup defaultValue="active" className="flex space-x-4">
          <div className="flex items-center space-x-2">
            <RadioGroupItem value="active" id="active" className="border-[#2E2E3A] text-blue-500" />
            <Label htmlFor="active" className="text-white">Active</Label>
          </div>
          <div className="flex items-center space-x-2">
            <RadioGroupItem value="inactive" id="inactive" className="border-[#2E2E3A] text-blue-500" />
            <Label htmlFor="inactive" className="text-white">Inactive</Label>
          </div>
        </RadioGroup>
      </div>
      <div className="flex-1 overflow-auto">
        <ScrollArea className="h-full">
          <div className="p-4">
            <h3 className="text-lg font-semibold mb-4 text-white">Product List</h3>
            {playlist.videos.map((video) => (
              <div key={video.id} className="flex items-center space-x-4 mb-4">
                ...
                <input type="checkbox" className="rounded text-blue-500 bg-[#13131A] border-[#2E2E3A]" />
              </div>
            ))}
          </div>
        </ScrollArea>
      ...
      <div className="p-4 border-t border-[#2E2E3A]">
        <Button className="w-full bg-[#3A3AF1] hover:bg-[#3A3AF1]/80 text-white">Update Playlist</Button>
      </div>
    </div>
  )
}
